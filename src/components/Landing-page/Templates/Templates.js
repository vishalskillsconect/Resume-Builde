    ...
    return (
        <section class="container my-5" id="Templates">
            <div class=" my-5">
                ...
                <p class="lead">Making a resume is the first step of any job search. Not sure how to make a resume? Our online Skills Connect gives you free resume templates to follow.</p>
            </div>
